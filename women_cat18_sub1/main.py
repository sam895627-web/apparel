...
# Hardcoded subcategory URLs for Apparel Group 1
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/women/apparel/hoodies-sweatshirts-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/arabic-fashion/kaftans/l/",
    "https://www.boutiqaat.com/ar-kw/women/apparel/shirts-tops/l/",
    "https://www.boutiqaat.com/ar-kw/women/apparel/t-shirts-tank-tops/l/",
    "https://www.boutiqaat.com/ar-kw/women/apparel/fabrics/l/",
    "https://www.boutiqaat.com/ar-kw/women/apparel/socks-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/apparel/sleep-loungewear-1739659248/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/apparel/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/apparel/excel-files"
            )
